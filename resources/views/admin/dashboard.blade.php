...
function dashboardAdmin() {
    return {
        ...
        async submitTambah() {
            ...
            try {
                const res = await fetch('{{ route("daftar-dokumen.store") }}', {
                    method: 'POST',
                    body:   fd
                });
        ...
        async submitEdit() {
            ...
            try {
                const url = `{{ url('dashboard/daftar-dokumen') }}/${this.editForm.id}`;
        ...
        async submitHapus() {
            ...
            try {
                const url = `{{ url('dashboard/daftar-dokumen') }}/${this.hapusForm.id}`;
                const res = await fetch(url, {
                    method:  'DELETE',
                    headers: {
