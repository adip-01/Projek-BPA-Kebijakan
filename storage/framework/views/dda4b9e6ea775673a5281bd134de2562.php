<?php $__env->startSection('title', 'Pusat Arsip Dokumen'); ?>
    ...
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <form method="GET" action="<?php echo e(route('dokumen.index')); ?>">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                    ...
                    <div class="relative">
                        <select name="category"
                            ...
                            <?php $__currentLoopData = ['Panduan','Pedoman','Buletin','RPS','Petunjuk Teknis','Peraturan Univ','Template','SOP','Kebijakan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="relative">
                        <select name="owner"
                            ...
                            <option value="Internal BPA"  <?php echo e(request('owner') === 'Internal BPA'  ? 'selected' : ''); ?>>Internal BPA</option>
                            <option value="Eksternal BPA" <?php echo e(request('owner') === 'Eksternal BPA' ? 'selected' : ''); ?>>Eksternal BPA</option>
                        </select>
                        <i data-lucide="chevron-down" class="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400"></i>
                    </div>
                ...
                <a href="<?php echo e(route('dokumen.create')); ?>"
                ...
                <table class="w-full min-w-[1080px] text-left">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/60">
                            <?php $__currentLoopData = ['Dokumen','Kategori & Pemilik','Tgl Efektif','Klausul','Versi & Status','Tautan & Aksi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="transition-colors hover:bg-gray-50/60">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($doc->title); ?></p>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <p class="mt-1.5 text-xs text-gray-500"><?php echo e($doc->owner); ?></p>
                                </td>

                                
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-600">
                                    <?php echo e($doc->formatted_effective_date); ?>

                                </td>

                                
                                <td class="px-6 py-4">
                                    <p class="max-w-[200px] truncate text-sm text-gray-500" title="<?php echo e($doc->klausul); ?>">
                                        <?php echo e($doc->klausul ?? '—'); ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 whitespace-nowrap">
                                        <span class="text-sm font-medium text-gray-700"><?php echo e($doc->version); ?></span>
                                        <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium
                                            <?php echo e($doc->status === 'Aktif' ? 'bg-green-50 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
                                            <span class="h-1.5 w-1.5 rounded-full <?php echo e($doc->status === 'Aktif' ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-1 whitespace-nowrap">
                                        ...
                                        <a href="<?php echo e(route('dokumen.edit', $doc)); ?>"
            ...
            <?php if($documents->hasPages()): ?>
                <div class="flex flex-col items-center justify-between gap-3 border-t border-gray-100 px-6 py-4 sm:flex-row">
                    <p class="text-sm text-gray-500">
                        Menampilkan
                        <span class="font-medium text-gray-700"><?php echo e($documents->firstItem()); ?>–<?php echo e($documents->lastItem()); ?></span>
                        dari <span class="font-medium text-gray-700"><?php echo e($documents->total()); ?></span> dokumen
                    </p>
                    <div class="flex items-center gap-1">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($documents->previousPageUrl()); ?>"
                        ...
                        <?php $__currentLoopData = $documents->getUrlRange(1, $documents->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($url); ?>"
                               class="flex h-9 w-9 items-center justify-center rounded-lg text-sm font-medium transition-colors
                                   <?php echo e($page == $documents->currentPage() ? 'bg-red-800 text-white' : 'border border-gray-200 text-gray-600 hover:bg-gray-50'); ?>">
                                <?php echo e($page); ?>
                        ...
                        <?php if($documents->hasMorePages()): ?>
                            <a href="<?php echo e($documents->nextPageUrl()); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (3)\SIMKEB\resources\views/dokumen/index.blade.php ENDPATH**/ ?>