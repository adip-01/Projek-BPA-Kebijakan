<?php $__env->startSection('title', 'Tambah Dokumen Baru'); ?>
                ...
                <div class="grid grid-cols-1 gap-x-5 gap-y-4 px-6 py-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input id="title" name="title" type="text"
                               ...
                               class="w-full rounded-lg border <?php echo e($errors->has('title') ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200'); ?> px-3 py-2.5 text-sm text-gray-800 outline-none transition-colors placeholder:text-gray-400 focus:border-red-700 focus:ring-2 focus:ring-red-100">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="category" name="category"
                                    class="w-full appearance-none rounded-lg border <?php echo e($errors->has('category') ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200'); ?> bg-white px-3 py-2.5 text-sm text-gray-800 outline-none transition-colors focus:border-red-700 focus:ring-2 focus:ring-red-100">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="owner" name="owner"
                                ...
                                <option value="" disabled <?php echo e(old('owner') ? '' : 'selected'); ?>>Pilih pemilik</option>
                                <option value="Internal BPA"  <?php echo e(old('owner') === 'Internal BPA'  ? 'selected' : ''); ?>>Internal BPA</option>
                                <option value="Eksternal BPA" <?php echo e(old('owner') === 'Eksternal BPA' ? 'selected' : ''); ?>>Eksternal BPA</option>
                            </select>
                            <i data-lucide="chevron-down" class="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400"></i>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input id="version" name="version" type="text"
                               value="<?php echo e(old('version', 'v1.0')); ?>"
                               placeholder="v1.0"
                               class="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-gray-800 outline-none transition-colors placeholder:text-gray-400 focus:border-red-700 focus:ring-2 focus:ring-red-100">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  class="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-gray-800 outline-none transition-colors placeholder:text-gray-400 focus:border-red-700 focus:ring-2 focus:ring-red-100 resize-none"><?php echo e(old('description')); ?></textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="klausul" name="klausul" rows="3"
                                  ...
                                  class="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-gray-800 outline-none transition-colors placeholder:text-gray-400 focus:border-red-700 focus:ring-2 focus:ring-red-100 resize-none"><?php echo e(old('klausul')); ?></textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <label for="document_file"
                            ...
                            <div class="mt-4 flex flex-wrap justify-center gap-2">
                                <?php $__currentLoopData = ['PDF', 'DOC', 'DOCX', 'XLS', 'XLSX', 'PPT', 'PPTX']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ext): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="rounded-full bg-white px-2.5 py-1 text-xs font-medium text-gray-500 ring-1 ring-gray-200">
                                        .<?php echo e(strtolower($ext)); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1">
                                <i data-lucide="alert-circle" class="h-3.5 w-3.5"></i> <?php echo e($message); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (3)\SIMKEB\resources\views/dokumen/create.blade.php ENDPATH**/ ?>