            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@mail.com"
                               class="w-full pl-10 pr-4 py-3 bg-white text-gray-900 placeholder:text-gray-400 border border-gray-300 rounded-lg focus:outline-none focus:border-red-800 focus:ring-1 focus:ring-red-800 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>">
                ...
                <div class="flex justify-between items-center mb-6 mt-4">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-bold text-red-800 hover:text-red-900">
                        Lupa password?
                    </a>
                </div>
            ...
            <p class="text-center text-gray-600 text-sm">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-red-800 hover:text-red-900">Daftar di sini</a>
            </p>
        </div>
...
<?php /**PATH D:\New folder (3)\SIMKEB\resources\views/auth/login.blade.php ENDPATH**/ ?>